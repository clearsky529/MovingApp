    ...
    */
    ...
    'redis' => [
        ...
        'default' => [
            ...
            'password' => array_key_exists('REDIS_PASSWORD', $_SERVER) ? $_SERVER['REDIS_PASSWORD'] : env('REDIS_PASSWORD', null),
            'port' => array_key_exists('REDIS_PORT', $_SERVER) ? $_SERVER['REDIS_PORT'] : env('REDIS_PORT', '6379'),
            'database' => array_key_exists('REDIS_CACHE_DB', $_SERVER) ? $_SERVER['REDIS_CACHE_DB'] : env('REDIS_CACHE_DB', '1'),
        ],
