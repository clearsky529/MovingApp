...
return [
    ...
    */
    ...
    'default' => array_key_exists('FILESYSTEM_DISK', $_SERVER) ? $_SERVER['FILESYSTEM_DISK'] : env('FILESYSTEM_DISK', 'local'),
    ...
    */
    ...
    'disks' => [
        ...
        'public' => [
            ...
            'url' => array_key_exists('APP_URL', $_SERVER) ? $_SERVER['APP_URL'] : env('APP_URL').'/storage',
            'visibility' => 'public',
        ],
        ...
        's3' => [
            ...
            'endpoint' => array_key_exists('AWS_URL', $_SERVER) ? $_SERVER['AWS_URL'] : env('AWS_URL'),
            'url' => array_key_exists('AWS_URL', $_SERVER) ? $_SERVER['AWS_URL'] : 'https://'. env('AWS_BUCKET').'.s3.'. env('AWS_DEFAULT_REGION').'.amazonaws.com/',
            'visibility' => 'public',
        ],
