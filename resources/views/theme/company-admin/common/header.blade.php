<header class="main-header">
  ...
  <?php   
    ...
    <!-- Logo -->
    <a href="{{ url('company-admin/home') }}" class="logo">
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{ $users_info->name }}</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                    <a href="{{ route('company-admin.profile') }}" class="btn btn-default btn-flat">@lang('common.profile')</a>
                    <a href="{{ route('company-admin.change-password') }}" class="btn btn-default btn-flat">@lang('common.change password')</a>
