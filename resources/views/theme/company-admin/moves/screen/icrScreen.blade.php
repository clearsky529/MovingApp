...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Screening ICR</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="col-lg-12">
            <iframe src="{{ route('company-admin.moves.screen-icr-pdf',Crypt::encrypt($id)) }}" width="100%" height="700px"></iframe>
          </div>
        </div>
      </div>
    </div>
