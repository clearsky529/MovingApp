...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Uplift Risk Assessment</li>
  </ol>
</section>
    ...
    <div class="col-lg-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Uplift Risk Assessment</h3>
        </div>
        <div class="box-body">
          <div class="col-lg-12">
            <iframe src="{{ route('company-admin.moves.uplift-risk-assessment-pdf',Crypt::encrypt($id)) }}" width="100%" height="700px"></iframe>
          </div>
        </div>
      </div>
    </div>
