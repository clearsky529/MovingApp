        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box box-primary">
                    ...
                    ?>
                        <div class="box-body">
                            <form action="{{ url('support-admin/move')}}" method="post">
                                {{ csrf_field() }}
                                <div class="col-md-4">
                          ...
                          @if($move->uplift)
                            <tr <?php if($move->uplift->status == 2) { ?> data-status="Completed" <?php } ?>>
                              ...
                              <td class="text-center">
                                            <a href="{{ url('/support-admin/move/view-move/'.Crypt::encrypt($move->id)) }}" class="btn btn-primary btn-mini" title="@lang('common.View')"><i class="fa fa-eye"></i></a>
                              </td>
                             </tr>
                          @endif  
                        @endforeach
                        ...
                        @foreach($moves as $move)
                          @if($move->delivery)
                            <tr <?php if($move->delivery->status == 2) { ?> data-status="Completed" <?php } ?>>
                              ...
                              <td class="text-center">
                                            <a href="{{ url('/support-admin/move/view-delivery/'.Crypt::encrypt($move->delivery->id)) }}" class="btn btn-primary btn-mini" title="@lang('common.View')"><i class="fa fa-eye"></i></a>
                             </td>
                             </tr>
                          @endif  
                        @endforeach
