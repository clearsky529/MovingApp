...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.move') }}">Moves</a></li>
        ...
        <div class="col-lg-6">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <h3 class="profile-username text-center">{{$delivery_move->contact->contact_name}}</h3>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Uplift Address</b> <a class="pull-right">{{$delivery_move->delivery_address}}</a>
                </li>
               <li class="list-group-item">
               ...
               <li class="list-group-item">
                ...
                <li class="list-group-item">
                  <b>Status</b> <a class="pull-right"><?php if($delivery_move->status == 0){ echo "Pending"; }elseif($delivery_move->status == 1){ echo "In-progress"; }else{ echo "Complete"; } ?></a>
                </li>
              </ul>
