          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                    <a href="{{ route('profile') }}" class="btn btn-default btn-flat">@lang('common.profile')</a>
                    <a href="{{ route('changepassword') }}" class="btn btn-default btn-flat">@lang('common.change password')</a>
