        ...
        <td align='center'>
            <center>
                <table border='0' cellpadding='35' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='520'>
                    <tr>
                        <td style="color: #000;text-decoration: none;font-size: 50px;"><b>kika</b> invitation</td>
                    </tr>
                </table>
            </center>
        </td>
                            ...
                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                <tr>
                                    <td align='center' valign='top'>
                                        <h2 style="font-size: 20px;margin-top: 0;">{{ $refered_user->referral_code }}</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' valign='top'>
                                        <p style='margin: 0 0 20px 0;font-size: 18px;'>
                                            {{ $refered_user->name }} has invited you to join them on Kika. Register for your free trial and enjoy the productivity benefits.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" valign="top">
                                        <a href="{{ url('/company-admin/register/step-1/'.$refered_user->referral_code) }}" style="color: #ffffff !important; text-decoration: none;font-size: 18px;"><h3 style="border-radius: 6px;background-color: #00a1fe;margin: 0;padding: 15px;">Register with Kika</h3></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
