        ...
        <td align='center'>
            <center>
                <table border='0' cellpadding='35' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='520'>
                    <tr>
                        <td style="color: #000;text-decoration: none;font-size: 50px;"><b>kika</b> subscription</td>
                    </tr>
                </table>
            </center>
        </td>
                            ...
                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                <tr>
                                    <td align='center' valign='top'>
                                        <h2 style="font-size: 20px;margin-top: 0;">Thank You !</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' valign='top'>
                                        <p style='margin: 0 0 20px 0;font-size: 18px;'>
                                            Your account has been charged {{$currency_name}}{{$currency_code}}{{ $amount }}
                                        </p>
                                    </td>
                                </tr>
                                <tr>
